...
"jail" folder will contain a folder named "
" having subfolders 1,2,3...
...
char restricted_owner[]="terminal";
	...
	*/
	else
	{
		...
		while(1)
		{
			...
			wait(&status);
			#ifdef SECURE
			ptrace(PTRACE_GETSIGINFO,pid, NULL, (siginfo_t *)&sig);
			if(sig.si_signo==SIGFPE || sig.si_signo==SIGSEGV)
			{
